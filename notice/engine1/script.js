...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fade",prev:"",next:"",duration:11*100,delay:19*100,width:960,height:360,autoPlay:true,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:true,captionEffect:"fade",controls:true,onBeforeStep:0,images:0});