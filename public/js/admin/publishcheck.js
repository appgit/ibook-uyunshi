function noticecheck(frm){
	if(frm.text.value==null||frm.text.value==''){
		alert('输入公告信息')
		return false;
	}
	...
	if(frm.effectivedays.value==null||frm.effectivedays.value==''){
		alert('请输入有效天数')
		return false;
	}
	return true;
...
function publishcheck(frm){
	...
	if(frm.price.value==null||frm.price.value==''){
		alert('请输入价格（二手币）')
		return false;
	}
	...
	if(frm.ishotsell.value==null||frm.ishotsell.value==''){
		alert('请选择是否热卖')
		return false;
	}
	if(frm.issepprice.value==null||frm.issepprice.value==''){
		alert('请选择是否特价')
		return false;
	}
